...
define("SMTP_UNAME", "cellphonex.hvnh@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "Hoclaptrinhweb123"); //Password for SMTP authentication
