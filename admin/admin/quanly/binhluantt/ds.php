<?php 
	...
	if(isset($_GET['idxoa'])){
     $id=$_GET['idxoa'];
     $sql="DELETE FROM tbl_binh_luan where id_binh_luan = $id";
	  ...
	  <table class="table align-items-center table-flush">
	    ...
	    <tbody>
	        ...
	        <tr>
	        	...
	        	<td>
	        		<a class="btn btn-outline-warning" href="?ql=binhluantt/ds&idxoa=<?php echo $row['id_binh_luan']?>">Xóa</a>
	        	</td>
	        </tr>
	    <?php $stt++; } ?>
	    </tbody>
