...
?>
	...
	{
		$sql="SELECT tbl1.id_don_hang, tbl1.id_san_pham, tbl1.so_luong, tbl1.don_gia, tbl1.thanh_tien, tbl2.anh, tbl2.ten_san_pham FROM tbl_chi_tiet_don_hang AS tbl1, tbl_san_pham AS tbl2 WHERE tbl1.id_san_pham=tbl2.id_san_pham AND tbl1.id_don_hang='".$_GET["id"]."'";
